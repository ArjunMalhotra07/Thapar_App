...
abstract class $ChatResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String message, String timestamp});
}
...
class _$ChatResponseCopyWithImpl<$Res, $Val extends ChatResponse>
  ...
  @override
  $Res call({Object? message = null, Object? timestamp = null}) {
    return _then(
      _value.copyWith(
...
class _$ChatResponseImpl implements _ChatResponse {
  const _$ChatResponseImpl({required this.message, required this.timestamp});
  ...
  @override
  String toString() {
    return 'ChatResponse(message: $message, timestamp: $timestamp)';
  }
